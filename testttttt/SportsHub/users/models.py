...
class RoleApplication(models.Model):
    ...
    # Additional fields for FitnessTrainer
    experience = models.IntegerField(blank=True, null=True)  # Added experience field
    certification = models.CharField(max_length=255, blank=True, null=True)
    training_goal = models.CharField(max_length=255, blank=True, null=True)
    certification_link = models.URLField(max_length=255, blank=True, null=True)
