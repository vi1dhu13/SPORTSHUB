...
#                 )
#                 fitness_user.save()
#             elif application.role.name == 'FitnessTrainer':
#                     fitness_trainer = FitnessTrainer(
#                         user=user,
#                         experience=application.experience,
#                         certification=application.certification,
#                         training_goal=application.training_goal,
#                     )
#                     fitness_trainer.save()

#                 # If the approved role is 'SportsTrainer'
#             elif application.role.name == 'SportsTrainer':
...
from .models import RoleApplication, CustomUser
from Members.models import FitnessUser, FitnessTrainer, SportsTrainer
from .forms import RoleApplicationForm  # Import the updated form
    ...
    if request.method == 'POST':
        ...
        if action == 'approve':
            ...
            if user.role == 'FitnessUser':
                ...
                fitness_trainer = FitnessTrainer(
                    user=user,
                    experience=application.experience,  # Corrected field name
                    certification=application.certification,
                    training_goal=application.fitness_goal,  # Use fitness_goal or training_goal as needed
