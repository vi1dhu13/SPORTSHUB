...
def make_reservation(request):
    ...
    if request.method == 'POST':
        ...
        selected_slot_id = request.POST.get('slot_selection')
        selected_user_id = request.POST.get('selected_user')
        selected_date = request.POST.get('selected_date')
        selected_equipment_id = request.POST.get('equipment_selection')

        try:
            selected_equipment = Equipment.objects.get(pk=selected_equipment_id)
            ...
            # Handle the case where the selected equipment does not exist
            # You can display an error message to the user in this case.
            pass
    ...
    for equipment in equipment_list:
        ...
        for i in range(num_days):
            ...
            # Query to get available slots for this equipment and day
